...
- **CHROMA-001 — Review — Perspective chromadepth particle laboratory.** Project a toroidally wrapped 3D particle field onto Canvas with inverse-distance size, camera orbiting, far-to-near painter sorting, and the ChromaDepth red-near through blue-far hue order. Speed continuously morphs each primitive from a circle toward a square while brightness supplies velocity accents without spending the depth hue channel.
