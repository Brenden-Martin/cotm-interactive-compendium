...
- **VINES-001 — Review:** Fractal Vines grows pointer-plantable spline lineages with probabilistic splitting and leaf termination, variable child counts, saturated logarithmic age-thickening, smooth correlated curvature, live classic-tree-to-stochastic-vine chaos, straight-to-fan-to-radial directional spread, deterministic cuttings, and a horizontally advected coherent wind field with independent parented branch and leaf responses. Tip-hinged leaves now grow to maturity; five-petal flowers usually bud over an existing leaf, open from an overlapped green bud, and traverse toward their chosen pigment. Optional painted sunlight/shade fields steer only new growth, and topology-aware coarsening preserves roots, forks, active tips, and every ornament while freeing the node budget. Full scrambles can remain unbounded or mutate repeatedly around a locked parent cutting.
...
- **VINES-003 — Horticultural dynamics and lineage mutation.** Re-anchored every leaf at its stem-facing tip, added gradual leaf growth and five-petal flowers that predominantly share leaf nodes, and exposed bloom timing, opening, pigment, and attachment probability. Added opt-in painted sunlight attraction and shade repulsion, topology-aware spline coarsening that never discards ornament nodes, roots, forks, or active lead tails, and a lockable parent cutting with bounded mutation distance for exploring families of related settings. Bouquet mode derives three stable species from the current or locked parent, rolls a reproducible mixture, and plants ten to eighteen sprouts whose branching, curvature, leaf, flower, scale, and pigment traits remain distinct under the shared live climate. Focused engine tests cover field polarity, topology preservation, and eased growth. This checkpoint remains private-workbench-only pending hands-on review.
