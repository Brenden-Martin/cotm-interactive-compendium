...
- **RATZ-005 — Review — Brenden mobile preset.** Adopt the photographed review settings as defaults: rat/cat correlation `3.46 s / 4.1 s`, wiggle `0`, panic `1.8`, clique attraction/radius `2.55 / 30 px`, separation/radius `4 / 63 px`, cheese `1.1`, pursuit `4.85`, cat repulsion `3.9`, trail avoidance/decay `1.85 / 24 s`, Fear/memory `7.2 / 14.85 s`, burst gain/curve `3.25 / 1.85`, and rat/cat maxima `170 / 805 px/s`.
