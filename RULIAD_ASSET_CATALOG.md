# Tales from the Ruliad — Image Asset Catalog

This register preserves the story-image collection independently from its eventual page layouts. Original attachment files remain untouched; the website copies use stable, descriptive names so future edits can relocate an image without losing its provenance.
...
These images are associated with *Tales from the Ruliad* but intentionally remain unassigned until their story placement is explicit.
