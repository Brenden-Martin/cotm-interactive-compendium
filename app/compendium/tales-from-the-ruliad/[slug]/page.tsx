          ...
          {story.art?.length ? (
            <div className={`ruliad-art-stack ruliad-art-stack-${story.art.length}`}>
              {story.art.map((illustration) => (
                <figure className="ruliad-art-frame ruliad-art-contain" key={illustration.src} style={illustration.ratio ? { aspectRatio: illustration.ratio } : undefined}>
          ...
          <div className="ruliad-image-grid">
            {story.archive.images.map((illustration, imageIndex) => (
              <figure key={illustration.src}>
                <div className="ruliad-archive-image ruliad-art-contain" style={illustration.ratio ? { aspectRatio: illustration.ratio } : undefined}>
